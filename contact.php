        ...
        <div class="navbar-collapse collapse bg-default" id="navbar_global">
          ...
          <ul class="navbar-nav align-items-lg-center ml-auto">
		   ...
		   <li class="nav-item">
			  ...
			  <li class="nav-item">
			   <div class="dropdown">
		  <a class="nav-link dropdown-toggle text-white " href="#" role="button" id="dropdownSignup" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		                  <span class="text-white nav-link-inner--text"
                  ><i class="text-white fas fa-user-plus"></i> Sign Up</span
                >
		  </a>

		  <div class="dropdown-menu" aria-labelledby="dropdownSignup">
			...
			<a class="dropdown-item" href="customer/cregister.php">Customer</a>
				  ...
				  <li class="nav-item">
			   <div class="dropdown">
		  <a class="nav-link dropdown-toggle text-white " href="#" role="button" id="dropdownLogin" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		                  <span class="text-white nav-link-inner--text"

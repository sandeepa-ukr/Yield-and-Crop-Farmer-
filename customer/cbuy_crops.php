                ...
                <div class="col-md-12 mb-3">
                    ...
                    <div class="text-black mb-3">
                        <div class="text-center mb-5">
                            <span class=" text-dark display-3"> Buy Crops </span>
                        </div>
                        <div class="card-body ">
						...
						?>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <input id="quantity" type="number" placeholder="Available Quantity"
                                                        max="10" name="quantity" required
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <button class="btn button text-dark form-control" name="add_to_cart"
                                                        type="submit" disabled>Add To Cart </button>
                                                </div>
                                            </td>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-responsive-md btn-table display"
                                    id="myTable">
                                    <tr class=" bg-dange">
					...
					?>
                                    ...
                                    <tr class=" bg-white">
                                        ...
                                        <td><a href="cbuy_crops.php?action=delete&id=<?php echo $values["item_id"]; ?>"
                                                type="button" class="btn btn-warning btn-block">Remove</a></td>
					...
					?>
							...
							require_once "StripePayment/config.php";
								...
								$session = \Stripe\Checkout\Session::create([
									...
									'mode' => 'payment',
									'success_url' => 'http://localhost/projects/agriculture-portal-main/customer/cupdatedb.php',
									'cancel_url' => 'http://localhost/projects/agriculture-portal-main/customer/cbuy_crops.php',
								]);

												

    					?>
                                            <button class="btn btn-info form-control" name="pay" type="submit"

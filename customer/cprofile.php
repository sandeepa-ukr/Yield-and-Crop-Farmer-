            ...
            <div class="row row-content">
                    ...
                    <div class="">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <img src="../assets/img/customers.png" alt="student" class="rounded-circle img-fluid"
                                    width="202px">
                                <div class="mt-3">
                                    <h4> Welcome <?php echo $login_session ?></h4>
                                    <button data-toggle="modal" data-target="#edit" class="btn button btn-danger">Edit
                                        Profile</button>
                ...
                <div id="edit" class="modal fade" role="dialog">
                            ...
                            <div class="modal-body ">
                                ...
                                <form class="col s12 l5 white-text" method="POST" autocomplete="new-password">
                                    ...
                                    <div class="form-group row">
                                        <label for="name" class="col-md-3 col-form-label text-black">Customer ID</label>
                                        <div class="col-md-9">
                                            <input name="id" class="form-control " value="<?php echo "$para1"?>"
                                                readonly />
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-black"> Customer Name
                                        </label>
                                        <div class="col-md-9">
                                            <input class="form-control" type="text" name="name"
                                                value="<?php echo "$para2"?>" />
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-black"> Email Address
                                        </label>
                                        <div class="col-md-9">
                                            <input class="form-control" type="email" name="email"
                                                value="<?php echo "$para5"?>" readonly />
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-black"> Mobile No
                                        </label>
                                        <div class="col-md-9">
                                            <input class="form-control" type="number" min="0" name="mobile"
                                                value="<?php echo "$para6"?>" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-black"> State</label>
                                        <div class="col-md-9">
					...
					?>
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-black"> Address
                                        </label>
                                        <div class="col-md-9">
                                            <input class="form-control" type="text" name="address"
                                                value="<?php echo "$para9"?>" />
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-black"> Pincode
                                        </label>
                                        <div class="col-md-9">
                                            <input class="form-control" type="number" min="0" min="6" name="pincode"
                                                value="<?php echo "$para10"?>" />
                                        </div>
                                    </div>


                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-black"> Password
                                        </label>
                                        <div class="col-9">
                                            <div class="input-group mb-3">
                                                ...
                                                <input name="pass" type="password" value="<?php echo "$para3"?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <button name="custupdate" class=" btn-block btn btn-success"><span
                                                    class="glyphicon glyphicon-edit"></span> Submit</button>
                                        </div>
                                    </div>

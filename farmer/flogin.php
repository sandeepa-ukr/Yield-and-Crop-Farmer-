                            ...
                            <div class=" card-body ">
                                ...
                                <form method="POST" action="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" required name="farmer_email"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-9">
                                            <div class="input-group mb-3">
                                                ...
                                                <input name="farmer_password" type="password" class="input form-control"
                                    ...
                                    <div class="form-group row">
                                        <div class="offset-md-3 col-md-2">
                                            <button type="submit" class="btn button text-dark" name="farmerlogin"
                                                id="submit">
                                                Login
                                            </button>
                                        </div>

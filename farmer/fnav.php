        ...
        <div class="navbar-collapse collapse bg-default" id="navbar_global">
            ...
            <ul class="navbar-nav align-items-lg-center ml-auto topnav" id="nav">
                ...
                <li class="nav-item dropdown" id="prediction">
                        <a class="nav-link dropdown-toggle text-white " href="#" role="button" id="dropdownPrediction"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="text-white nav-link-inner--text"><i class="text-white fas fa-magic"></i>
                                Prediction</span>
                        </a>

                        <div class="dropdown-menu" aria-labelledby="dropdownPrediction">
                ...
                <li class="nav-item" id="recommendation">
                    <div class="dropdown">
                        <a class="nav-link dropdown-toggle text-white " href="#" role="button"
                            id="dropdownRecommendation" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <span class="text-white nav-link-inner--text"><i class="text-white fas fa-gavel"></i>
                                Recommendation</span>
                        </a>

                        <div class="dropdown-menu" aria-labelledby="dropdownRecommendation">
                            <a class="dropdown-item" href="fcrop_recommendation.php">Crop Recommendation​</a>
                            <a class="dropdown-item" href="ffertilizer_recommendation.php">Fertilizer
                                Recommendation​</a>
                        </div>
                    </div>
                </li>
			   ...
			   <div class="dropdown">
		  <a class="nav-link dropdown-toggle text-white " href="#" role="button" id="dropdownTrade" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		                  <span class="text-white nav-link-inner--text"
                  ><i class="text-white fas fa-shopping-cart"></i> Trade</span
                >
		  </a>

		   <div class="dropdown-menu" aria-labelledby="dropdownTrade">
			...
			<a class="dropdown-item" href="fselling_history.php">Selling History​</a>
			   ...
			   <div class="dropdown">
		  <a class="nav-link dropdown-toggle text-white " href="#" role="button" id="dropdownTools" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		                  <span class="text-white nav-link-inner--text"
			...
			<a class="dropdown-item" href="fnewsfeed.php"> <i class="text-dark fas fa-newspaper"></i>News Feed​</a>
                ...
                <li class="nav-item" id="profile">
                    <a href="fprofile.php" class="nav-link">
                        <span class="text-white nav-link-inner--text font-weight-bold"><i
                                class="text-white fas fa-user"></i> <?php echo $para2 ?> </span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="flogout.php" class="nav-link">
                        <span class="text-white nav-link-inner--text font-weight-bold"><i
                                class="text-danger fas fa-power-off"></i> Logout </span>
                    </a>
                </li>
...
//     if (
//         path.includes("fcrop_prediction.php") ||
//         path.includes("fyield_prediction.php") ||
//         path.includes("frainfall_prediction.php")
//     ) {
//         $("#prediction > .dropdown > a").addClass("activa");
//     }

//     if (
//         path.includes("fcrop_recommendation.php") ||
//         path.includes("ffertilizer_recommendation.php")
//     ) {
//         $("#recommendation > .dropdown > a").addClass("activa");
//     }
// });
</script>
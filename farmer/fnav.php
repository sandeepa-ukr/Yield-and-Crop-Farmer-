<nav
    ...
    >
	 ...
	 <li class="nav-item" id="prediction">
			   <div class="dropdown">
		  <a class="nav-link dropdown-toggle text-white " href="#" role="button" id="dropdownPrediction" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		   ...
		   <a class="dropdown-item" href="fyield_prediction.php">Yield Prediction​</a>
			<a class="dropdown-item" href="frainfall_prediction.php">Rainfall Prediction​</a>
			 ...
			 <li class="nav-item" id="recommendation">
			   <div class="dropdown">
		  <a class="nav-link dropdown-toggle text-white " href="#" role="button" id="dropdownRecommendation" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		                  <span class="text-white nav-link-inner--text"

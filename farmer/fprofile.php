            ...
            <div class="row ">
                ...
                <div id="edit" class="modal fade" role="dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body bg-gradient-danger">
                                ...
                                <form class="col s12 l5 white-text" method="POST" autocomplete="new-password">
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white"> Farmer Name
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white"> Email Address
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white"> Mobile No
                                        </label>
                                        <div class="col-md-9">
					...
					?>
                                    ...
                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white"> District
                                        </label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" type="text" name="city"
                                                value="<?php echo "$para11"?>" />
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="staffid" class="col-md-3 col-form-label text-white"> Password
                                        </label>
                                        <div class="col-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <button name="farmerupdate" class=" btn-block btn btn-success"><span

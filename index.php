                            ...
                            <div class="info info-horizontal info-hover-success">
                                <div class="description pl-4">
                                    ...
                                    <p class=" ">Farmers can get recommendations for crop n fertilizer and even
                                        predict the weather and get the news related to agriculture. Farmers can
                                        directly sell the crops to the customers.</p>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="info info-horizontal info-hover-warning mt-5">
                                <div class="description pl-4">
                                    ...
                                    <p class=" ">Customers can buy crops directly from the faarmers without the
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-8 mr-auto text-left">
                            <div class="pr-md-5">
                                <div class="icon icon-lg icon-shape icon-shape-primary shadow rounded-circle mb-5"> <i
                                        class="ni ni-favourite-28"> </i></div>
